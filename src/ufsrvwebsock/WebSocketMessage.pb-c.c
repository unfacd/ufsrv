...
{
  static const WebSocketRequestMessage init_value = WEB_SOCKET_REQUEST_MESSAGE__INIT;
  *message = init_value;
}
...
{
  static const WebSocketResponseMessage init_value = WEB_SOCKET_RESPONSE_MESSAGE__INIT;
  *message = init_value;
}
...
{
  static const WebSocketMessage init_value = WEB_SOCKET_MESSAGE__INIT;
  *message = init_value;
}
...
static const ProtobufCFieldDescriptor web_socket_message__field_descriptors[5] =
{
  {
    "type",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    offsetof(WebSocketMessage, n_headers),
    offsetof(WebSocketMessage, headers),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
