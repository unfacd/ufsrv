...
UFSRVResult *IsUserAllowedToChangeFenceUserPrefProfileSharing(Session *sesn_ptr, FenceUserPreference *sesn_msg_pref_ptr, DataMessage *data_msg_ptr_received, UfsrvEvent *event_ptr, CallbackCommandMarshaller );
