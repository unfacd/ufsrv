...
FenceRecord *MakeFenceRecordInProto (Session *sesn_ptr, Fence *f_ptr, FenceRecord *fence_record_ptr_in);
...
FenceUserRecordsDescription *MakeFenceMembersInProto (Session *sesn_ptr_this,  Fence *f_ptr, unsigned long, unsigned long);
...
void DestructFenceRecordsProto (FenceRecord **fence_records_ptr, unsigned count, bool self_destruct);
...
AttachmentRecord *MakeAttachmentRecordInProto (AttachmentDescriptor *attachment_ptr, AttachmentRecord *, bool flag_dup);
void DestructAttachmentRecord (AttachmentRecord  *, bool flag_self_destruct);
