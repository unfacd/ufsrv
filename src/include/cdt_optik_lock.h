...
#ifndef SRC_INCLUDE_CDT_OPTIK_LOCK_H_
#define SRC_INCLUDE_CDT_OPTIK_LOCK_H_

#include <utils_cdt.h>
#include <utils_cdt_atomics.h>
...
#define OPTIK_PAUSE() __asm volatile ("mfence");
...
#endif /* SRC_INCLUDE_CDT_OPTIK_LOCK_H_ */
