...
UFSRVResult *UpdateUserLocationAssignment (Session *sesn_ptr, struct json_object *jobj, unsigned long call_flags_sesn);
...
int ProcessUserLocation (Session *sesn_ptr, LocationDescription *, unsigned short);//in user.c
