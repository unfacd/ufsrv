...
RESCODE_LOCATION_UNINIT, RESCODE_LOCATION_INIT, RESCODE_LOCATION_UNCHANGED, RESCODE_LOCATION_CHANGED,

RESCODE_PROTOCOL_NOSSL, RESCODE_PROTOCOL_WSHANDSHAKE, RESCODE_PROTOCOL_NOTSUPPORTED, RESCODE_PROTOCOL_DATA, RESCODE_PROTOCOL_CMD_VERIFICATION,

RESCODE_UFSRVGEOGROUP_DEFAULT,

RESCODE_UFSRV_INTERBROADCAST, RESCODE_UFSRV_STORE_MSG,
...
RESCODE_PROG_LOCKED_BY_THIS_THREAD=10011, RESCODE_PROG_RESOURCE_CACHED=10012
};
