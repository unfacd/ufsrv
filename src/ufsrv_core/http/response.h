...
ssize_t onion_response_write_with_known_content_length(InstanceHolderForSession *instance_sesn_ptr, onion_response *res, const char *data, size_t length, const char *content_type);
