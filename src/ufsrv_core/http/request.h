 ...
 * @ingroup request.
 * Make sure  this is synched with with the array defined in h_request.c
...
enum onion_request_flags_e {
  ...
  OR_METHODS=0x0FU,
	...
	/// Some flags at 0x0F0
	OR_HTTP11=0x10U,
	OR_POST_MULTIPART=0x20U,
	OR_POST_URLENCODED=0x40U,

	/// Server flags are at 0x0F00.
	OR_NO_KEEP_ALIVE=0x0100U,
  OR_HEADER_SENT_=0x0200U,  ///< Dup name from onion_response_flags, same meaning.

	/// Errors at 0x0F000.
	OR_INTERNAL_ERROR=0x01000U,
	OR_NOT_IMPLEMENTED=0x02000U,
	OR_NOT_FOUND=0x03000U,
  OR_FORBIDDEN=0x04000U,
};
...
onion_connection_status onion_request_write(Session *, onion_request *req, const char *data, size_t length);

size_t HTTPProtoGetCurrentFileSize(onion_request *req);
