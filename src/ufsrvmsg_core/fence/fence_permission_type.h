...
/*! Main data model for representing a fence permission type. This includes configuration data, plus actual users for which
 * the permission applies. Under current model a fence can have many permission modes as defined in \ref EnumFencePermissionType. */
