...
void ProvideFencePermissionsInProto(Session *sesn_ptr, Fence *f_ptr, FenceRecord *fence_record_ptr);
void ProvideFencePermissionsUserListsInProto (Session *sesn_ptr, Fence *f_ptr, FenceRecord *fence_record_ptr);
void ProvideFenceListSemanticsInProto (Fence *f_ptr, FenceRecord *fence_record_ptr);
void ProvideFencePrivacyModeInProto (Fence *f_ptr, FenceRecord *fence_record_ptr);
void ProvideFenceTypeInProto (Fence *f_ptr, FenceRecord *fence_record_ptr);
void ProvideFenceDeliveryModeInProto (Fence *f_ptr, FenceRecord *fence_record_ptr);
void ProvideFenceJoinModeInProto (Fence *f_ptr, FenceRecord *fence_record_ptr);
void ProvideFenceUserPreferencesInProto(Session *sesn_ptr, FenceStateDescriptor *fstate_ptr, FenceRecord *fence_record_ptr);

FenceRecord *ProvideFenceRecordInProto (InstanceContextForSession *ctx_ptr, InstanceContextForFence *ctx_f_ptr, FenceRecord *fence_record_ptr_in);
FenceRecord *ProvideFenceRecordInProtoAsIdentifier(Session *sesn_ptr, Fence *f_ptr, FenceRecord *fence_record_ptr_in,
                                                   bool isIncludeCname);
FenceRecord *ProvideFenceRecordInProtoAsIdentifierByParams (Session *sesn_ptr, unsigned long fid, FenceRecord *fence_record_ptr_in);
FenceUserRecordsDescription *ProvideFenceMembersInProto (InstanceContextForSession *ctx_ptr, InstanceContextForFence *ctx_f_ptr, unsigned long sesn_call_flags, unsigned long fence_call_flags);
FenceUserRecordsDescription *ProvideFenceInviteListFromNamesInProto (Session *sesn_ptr, char **members_invited, size_t members_sz, unsigned call_flags);
FenceUserRecordsDescription *ProvideFenceInviteListInProto (Session *sesn_ptr, Fence *f_ptr, unsigned call_flags);
...
CollectionDescriptor *ProvideFenceRecordsListFromFenceEventsInProto (Session *sesn_ptr, FenceEvent **fence_events, size_t fence_events_sz, unsigned long call_flags, CollectionDescriptor *collection_ptr_in);
FenceUserRecordsDescription  *ProvideFenceLinkJoinMembersInProto(InstanceContextForSession *ctx_ptr, InstanceContextForFence *ctx_f_ptr, unsigned long sesn_call_flags, unsigned long fence_call_flags);
FenceUserRecordsDescription  *ProvideFenceBannedMembersInProto(InstanceContextForSession *ctx_ptr, InstanceContextForFence *ctx_f_ptr, unsigned long sesn_call_flags, unsigned long fence_call_flags);
//FenceRecord *MakeFenceRecordInProto (Session *sesn_ptr, Fence *f_ptr, unsigned call_flags);
LocationRecord *ProvideUserLocationInProto (const User *user_ptr, bool flag_digest_mode);
LocationRecord *ProvideFenceLocationInProto (const Fence *f_ptr, bool flag_digest_mode);
LocationRecord *ProvideLocationDescriptionInProto (const LocationDescription *loc_ptr, bool flag_digest_mode, bool flag_dup_mode, LocationRecord *location_record_ptr_out);
void ProvideFenceKeyInProto(unsigned char *fence_key, FenceRecord *fence_record, bool flag_by_ref);
...
CollectionDescriptor *TEMPProvideAttachmentRecordFromAttachmentPointerInProto (AttachmentPointer *attachment_pointer_ptr, CollectionDescriptor *collection_attachment_records_out);
