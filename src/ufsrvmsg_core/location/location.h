...
UFSRVResult *UpdateUserLocationAssignment(Session *sesn_ptr, ClientContextData *, enum GeoLocRoamingTrigger geoloc_trigger, unsigned long call_flags_sesn);
UFSRVResult *UpdateHomebaseGeoLocDynamicAssignment (Session *sesn_ptr, const char *baseloc, unsigned long call_flags_sesn);
UFSRVResult *UpdateHomebaseGeoLocUserPrefAssignment (Session *sesn_ptr, const char *baseloc, unsigned long call_flags_sesn);
UFSRVResult *UpdateLocationByWireProto (InstanceContextForSession *ctx_ptr, const LocationRecord *location_record_ptr);
bool BuildUserLocationByProto (Session *sesn_ptr, LocationRecord *location_record_ptr);
UFSRVResult *UpdateUserLocationByUserByWireProto(Session *sesn_ptr, const LocationRecord *location_record_ptr, LocationChangeZoneMarker *location_marker_ptr_out, unsigned long call_flags_sesn);
LocationDescription *DetermineLocationByServerByWireProto(Session *sesn_ptr, const LocationRecord *location_record_ptr);
int ProcessUserLocationRoaming(InstanceHolderForSession *instance_sesn_ptr, LocationDescription *loc_ptr, const LocationChangeZoneMarker *location_marker_ptr, unsigned short origin);//in user.c
...
LocationDescription *ProvideLocationDescriptionFromSerialised(char *location_serialised, LocationDescription *location_ptr_out, bool is_validate_address);
