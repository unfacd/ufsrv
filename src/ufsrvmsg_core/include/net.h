...
unsigned long HashNetAddress(const struct sockaddr_in *address);
unsigned long HashTwoWayNetAddress(const struct sockaddr_in *address_src, const struct sockaddr_in *address_dst);
