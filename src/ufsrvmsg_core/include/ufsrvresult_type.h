...
enum {
	RESULT_TYPE_NOOP=0,
	RESULT_TYPE_IOERR, RESULT_TYPE_LOGICERR, RESULT_TYPE_NETERR, RESULT_TYPE_OSERR,
...
//result_type
enum {
RECODE_NONE=0, RESCODE_SERVICED, RESCODE_NOT_IMPLEMENTED,

RECODE_USER_AUTHENTICATION, RESCODE_USER_SIGNON, RESCODE_USER_INITIALISED,
RESCODE_SESN_HARDSPENDED, RESCODE_SESN_SOFTSPENDED, RESCODE_SESN_INVALIDATED, RESCODE_SESSION_FENCE_INTEGRITY,

RESCODE_USER_FENCE_FULL = 100, RESCODE_USER_FENCE_PRIVATE,RESCODE_USER_FENCE_JOINED,RESCODE_USER_FENCE_MADE,
...
RESCODE_FENCE_EMPTY_INVITATION_LIST,RESCODE_FENCE_INVITATION_LIST, RESCODE_FENCE_MEMBERSHIP, RESCODE_FENCE_JOIN_LINKJOIN_LIST, RESCODE_FENCE_BANNED_LIST, RESCODE_FENCE_LIST_SELFLOADED, RESCODE_FENCE_OWNERSHIP,
RESCODE_FENCE_EXISTS, RESCODE_FENCE_DOESNT_EXIST, RESCODE_FENCE_NAMING, RESCODE_FENCE_IDENTICAL, RESCODE_FENCE_INVITE_SIZE, RESCODE_FENCE_UNKNOWN_TYPE,
RESCODE_FENCE_DATA_UPDATED, RESCODE_FENCE_EVENT_GENERATION, RESCODE_FENCE_EXPIRY, RESCODE_FENCE_DESTRUCTED, RESCODE_FENCE_PERMISSION_PROHIBITED, RESCODE_FENCE_PERMISSION, RESCODE_FENCE_PERMISSION_PRESENTATION, RESCODE_FENCE_PERMISSION_MEMBERSHIP, RESCODE_FENCE_PERMISSION_MESSAGING, RESCODE_FENCE_PERMISSION_ATTACHING, RESCODE_FENCE_PERMISSION_CALLING,
RESCODE_FENCE_SESSION_INTEGRITY,RESCODE_FENCE_STATE, RESCODE_FENCE_INVALID_MAXMEMBERS, RESCODE_FENCE_INVALID_DELIVERY_MODE, RESCODE_FENCE_INVALID_JOIN_MODE, RESCODE_FENCE_LINKJOIN_NONCE,
	RESCODE_FENCE_MISSING_PARAM,

RESCODE_USERINFO_BAKENDERR = 200, RESCODE_USERINFO_SUCCESS, RESCODE_USERINFO_UNKNOWN, RESCODE_ACCOUNT_DISABLED,RESCODE_USER_INVALID_UID,
...
RESCODE_LOCATION_UNINIT = 300, RESCODE_LOCATION_INIT, RESCODE_LOCATION_UNCHANGED, RESCODE_LOCATION_CHANGED,

RESCODE_MESSAGE_REVOKED = 400, RESCODE_TIME_THRESHOLD_LAPSED,

RESCODE_USERCMD_MISSING_PARAM = 500, RESCODE_USERCMD_TOOLONG_PARAM,

RESCODE_ACCOUNT_REGISTRATION_CODE_MISMATCH = 600,

RESCODE_IO_SUSPENDED = 100000, RESCODE_IO_USEMSG, RESCODE_IO_WOULDBLOCK, RESCODE_IO_CONNECTIONCLOSED,RESCODE_IO_MSGPARSED,RESCODE_IO_FRAMED,RESCODE_IO_MSGDISPATCHED,
...
RESCODE_LOGIC_WOULDLOCK = 100100, RESCODE_LOGIC_CANTLOCK,RESCODE_LOGIC,RESCODE_LOGIC_NOCMND,RESCODE_LOGIC_EMPTY_RESOURCE,RESCODE_LOGIC_WITH_RESOURCE,
RESCODE_LOGIC_IDENTICAL_RESOURCE,

RESCODE_PROTOCOL_NOSSL = 100200, RESCODE_PROTOCOL_WSHANDSHAKE, RESCODE_PROTOCOL_NOTSUPPORTED, RESCODE_PROTOCOL_DATA, RESCODE_PROTOCOL_CMD_VERIFICATION,

RESCODE_UFSRVGEOGROUP_DEFAULT,

RESCODE_UFSRV_INTERBROADCAST = 100300, RESCODE_UFSRV_STORE_MSG,

RESCODE_BACKEND_CONNECTION = 100500,RESCODE_BACKEND_DATA,RESCODE_BACKEND_DATA_EMPTYSET,RESCODE_BACKEND_DATA_PARTIALSET, RESCODE_BACKEND_DATA_EXISTINGSET,
...
RESCODE_BACKEND_COMMAND, RESCODE_BACKEND_CONSTRAINT,RESCODE_BACKEND_DATA_TRANSFORMATION,

RESCODE_PROG_NULL_POINTER = 100600,RESCODE_PROG_MEMORY_EXHAUSTED, RESCODE_PROG_MISSING_PARAM, RESCODE_PROG_HASHED,RESCODE_PROG_LOCKED,RESCODE_PROG_WONTLOCK,
RESCODE_PROG_INCONSISTENT_STATE, RESCODE_PROG_JSON_PARSER,RESCODE_PROG_PROTOBUF_UNPACKER, RESCODE_PROG_PROTOBUF_PACKER, RESCODE_PROG_INCONSISTENT_DATA,
RESCODE_PROG_LOCKED_BY_THIS_THREAD, RESCODE_PROG_RESOURCE_CACHED
};
