...
#include <ufsrvmsg_core/user/user_preferences_type.h>
...
UserPreferenceDescriptor *SetUserPreference(ClientContextData *ctx_ptr, UserPreferenceDescriptor *pref_ptr, PrefsStore pref_store, UfsrvEvent *event_ptr);
...
json_object *JsonValueFormatForGenericInteger(Session *sesn_ptr, UserPreferenceDescriptor *preference_descriptor, json_object *jobj_out, PrefsStore prefs_store);
json_object *JsonValueFormatForGenericString(Session *sesn_ptr, UserPreferenceDescriptor *preference_descriptor, json_object *jobj_out, PrefsStore prefs_store);
