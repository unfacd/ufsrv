...
#include <ufsrvmsg_core/user/user_type.h>//for UserPrefsOffsets
...
struct UserPreferenceDescriptor {
	...
	ClientContextData * (*pref_value_formatter)(ClientContextData *, UserPreferenceDescriptor *, ClientContextData *, PrefsStore);
