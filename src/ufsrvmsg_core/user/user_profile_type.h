...
#define PROFILE_KEY_LEN SignalPROFILE_KEY_LEN //32
#define PROFILE_KEY_COMMITMENT_LEN SignalPROFILE_KEY_COMMITMENT_LEN //97
#define PROFILE_KEY_VERSION_ENCODED_LEN SignalPROFILE_KEY_VERSION_ENCODED_LEN //64
#define PROFILE_KEY_CREDENTIAL_RESPONSE_LEN SignalPROFILE_KEY_CREDENTIAL_RESPONSE_LEN //457
#define PROFILE_KEY_CREDENTIAL_REQUEST_LEN SignalPROFILE_KEY_CREDENTIAL_REQUEST_LEN //329
