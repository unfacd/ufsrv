...
UserRecord *ProvideUserRecordFromUsernameInProto (Session *sesn_ptr, const char *username, UserRecord *user_record_supplied, bool flag_digest_mode);
UserRecord *ProvideUserRecordFromSessionInProto (Session *sesn_ptr_source, UserRecord *user_record_supplied, bool flag_digest_mode, bool flag_ref_mode);
UserRecord *ProvideUserRecordFromUseridInProto (Session *sesn_ptr_carrier, unsigned long userid, UserRecord *user_record_supplied);
UserRecord *ProvideUserRecordForSelfInProto (const Session *sesn_ptr, bool flag_digest_mode);
void ProvideUfsrvUidInProto(UfsrvUid *uid_ptr, ProtobufCBinaryData *proto_ptr, bool is_by_ref);
...
CollectionDescriptor *ProvideSessionMessageUserPreferenceInProto (Session *sesn_ptr, CollectionDescriptor *pref_collection_ptr, CollectionDescriptor *collection_ptr_out);
...
UFSRVResult *ProvideSenderCertificate (Session *sesn_ptr, SenderCertificateContext *cert_ctx_ptr);
UFSRVResult *ProvideIdentityCertificate (Session *sesn_ptr, IdentityCertificate *cert_identity_ptr, ServerCertificate *cert_server_ptr);
