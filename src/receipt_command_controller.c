...
/**
 * 	@brief: ReceiptCommand is generated by the sender(sesn_ptr_originator) to acknowledge a prior event generated by
 * 	another user in the same fence (sesn_ptr_target)
 */
...
_CommandControllerReceiptRead(InstanceContextForSession *, WebSocketMessage *wsm_ptr_orig, DataMessage *data_msg_ptr, ReceiptCommand__CommandTypes receipt_type);
...
inline static UFSRVResult *_MarshalReceiptForRead(InstanceHolderForSession *, WebSocketMessage *wsm_ptr_orig, DataMessage *data_msg_ptr_received, ReceiptContext *context_ptr, ReceiptCommand__CommandTypes receipt_type);
 ...
 */
UFSRVResult *
CommandCallbackControllerReceiptCommand(InstanceContextForSession *ctx_ptr_local_user, WebSocketMessage *wsm_ptr_received, DataMessage *data_msg_ptr)
{
    ...
    case RECEIPT_COMMAND__COMMAND_TYPES__READ:
      _CommandControllerReceiptRead(ctx_ptr_local_user, NULL, data_msg_ptr, RECEIPT_COMMAND__COMMAND_TYPES__READ);
      break;
    ...
    case RECEIPT_COMMAND__COMMAND_TYPES__VIEWED:
      _CommandControllerReceiptRead(ctx_ptr_local_user, NULL, data_msg_ptr, RECEIPT_COMMAND__COMMAND_TYPES__VIEWED);//Note: semantics same as read receipt
      break;
 ...
 *	@param receipt_type specify receipt type. This is currently limited to  ReceiptCommand__CommandTypes::RECEIPT_COMMAND__COMMAND_TYPES__READ OR ReceiptCommand__CommandTypes::RECEIPT_COMMAND__COMMAND_TYPES__VIEWED because they have the same semantics.
 * 	@locked RW sesn_ptr: must be locked by the caller
 * 	@locks RW f_ptr: issues flags to cause locking
 * 	@unlocks f_ptr:
 */
inline static UFSRVResult *
_CommandControllerReceiptRead(InstanceContextForSession *ctx_ptr, WebSocketMessage *wsm_ptr_orig, DataMessage *data_msg_ptr, ReceiptCommand__CommandTypes receipt_type)
{
    ...
    _MarshalReceiptForRead(ctx_ptr->instance_sesn_ptr, wsm_ptr_orig, data_msg_ptr, &receipt_context, receipt_type);
 ...
 * 	@param receipt_type specify receipt type. This currently limited or  ReceiptCommand__CommandTypes::RECEIPT_COMMAND__COMMAND_TYPES__READ OR ReceiptCommand__CommandTypes::RECEIPT_COMMAND__COMMAND_TYPES__VIEWED because they have the same semantics.
 ...
 */
inline static UFSRVResult *
_MarshalReceiptForRead(InstanceHolderForSession *instance_sesn_ptr, WebSocketMessage *wsm_ptr_orig, DataMessage *data_msg_ptr_received, ReceiptContext *context_ptr, ReceiptCommand__CommandTypes receipt_type)
{
	...
	_PrepareMarshalMessageForReceipt(&envelope_marshal, SessionOffInstanceHolder(context_ptr->instance_sesn_ptr_originator), f_ptr, context_ptr->fence_event_ptr, NULL, receipt_type, COMMAND_ARGS__SYNCED);
  ...
  ProvideUfsrvUidInProto(&SESSION_UFSRVUIDSTORE(sesn_ptr), &(receipt_command.uid_originator), true);//don't reference data_msg_ptr_received->ufsrvcommand->receiptcommand->uid_originator;
  ...
  UfsrvCommandInvokeUserCommand(&(InstanceContextForSession) {instance_sesn_ptr, sesn_ptr},
                                ...
                                wsm_ptr_orig, NULL, &ufsrv_description, uSETACCOUNT_ATTRS_V1_IDX);//todo: update command name
