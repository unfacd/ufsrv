 ...
 */
int stun_request(InstanceContext *instance_context, struct stun_ctrans **ctp, struct stun *stun, int proto,
		 ...
		 stun_resp_h *resph, void *arg, uint32_t attrc, ...)
{
	...
	mb->pos = presz;
	err = stun_ctrans_request(instance_context, ctp, stun, proto, sock, dst, mb, tid, method,
