...
ufsrv_geogroup=3
server_run_mode="shadow" --in clustered mode this server won't accept client connection, but will process INTER broadcasts
...
--db backend "db.ufsrv.unfacd.com", "ufsrv_user", "c*", "ufsrv", 19800, NULL);
ufsrv_db_backend={
  port=19800,
